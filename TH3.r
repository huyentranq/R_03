...
my_pie1<-pie(data_2023,labels,radius=1,col=mycol,init.angle=90,main='tỉ trọng năm 2023')
my_pie2<-pie(data_2022,labels,radius=1,col=mycol,init.angle=90,main='tỉ trọng năm 2022')
